    ...
    return (
        <div className='lg:bg-hero-layer bg-hero-bg-set bg-no-repeat max-lg:bg-center lg:min-h-[726px] relative max-lg:bg-light-gray' id='home'>
            <div className='container'>
                <div className='lg:flex-row flex-col flex justify-between lg:pt-[125px] max-lg:py-14 max-sm:py-12 gap-5'>
                    <div className='lg:w-[570px] w-full flex flex-col justify-center'>
                        <div className='flex flex-col justify-center max-lg:items-center'>
                            ...
                            <Description classStyle={'lg:max-w-[570px] pt-2 max-lg:text-center'} text={'Vulputate tristique habitant neque, accumsan. Vitae ultrices nulla erat nibh aliquam, quis tempus volutpat arcu. Leo convallis luctus dis malesuada turpis non consequat ac.'} />
                    ...
                    <div className='lg:w-[398px] w-full flex max-lg:justify-center max-lg:items-center'>
                        <img width={398} height={446.7} className='max-w-[398px] pointer-events-none w-full' src="/assets/images/webp/hero-image.webp" alt="hero-image" />
                    </div>
